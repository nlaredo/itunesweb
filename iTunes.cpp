...
L"div{background:#99b;width:0%;height:1em;text-align:right;}\r\n"
L"</style>\r\n"
L"<script type=\"text/javascript\">\r\n"
L"function newtime()\r\n"
L"{\r\n"
L"	var now = document.getElementById('now').innerHTML;\r\n"
L"	var tot = document.getElementById('total').innerHTML;\r\n"
L"	var state = document.getElementById('state').innerHTML;\r\n"
L"	var secnow = new Date('01/01/1970 '+now+' UTC').getTime();\r\n"
L"	var negtot = 0;\r\n"
L"	if (tot.substring(0,1) == '-') {\r\n"
L"		tot = tot.substring(1); negtot = secnow;\r\n"
L"	}\r\n"
L"	var sectot = negtot + new Date('01/01/1970 '+tot+' UTC').getTime();\r\n"
L"	var pct = secnow * 100 / sectot;\r\n"
L"	secnow += 1000; sectot -= secnow;\r\n"
L"	var d = new Date(); d.setTime(secnow);\r\n"
L"	document.getElementById('now').innerHTML =\r\n"
L"	        d.toUTCString(now).substring(17,25);\r\n"
L"	d.setTime(sectot);\r\n"
L"	document.getElementById('total').innerHTML =\r\n"
L"		'-'+d.toUTCString(now).substring(17,25);\r\n"
L"	if (state == 'play') {\r\n"
L"		if (sectot <= 0) window.location='/';\r\n"
L"		else setTimeout('newtime();', 1000);\r\n"
L"	}\r\n"
L"	document.getElementsByName(state)[0].style.color='#bbd';\r\n"
L"	document.getElementById('progress').style.width=pct+'%%';\r\n"
L"}\r\n"
L"</script>\r\n"
L"</head>\r\n"
